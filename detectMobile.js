      ...
      messageDiv.innerHTML = `
          ...
          <div style="margin-top: 40px;">
              ...
              <ul style="list-style: none; padding: 0; margin: 15px 0;">
                  ...
                  <li style="margin-bottom: 10px;">
                      <a href="https://soulixion.itch.io/onlydot" target="_blank" style="color: #0000ff; text-decoration: underline;">Dodge In Space</a>
                  </li>
                  <li style="margin-bottom: 10px;">
                      <a href="https://soulixion.itch.io/onlydot" target="_blank" style="color: #0000ff; text-decoration: underline;">Lazers Colors</a>
                  </li>
                  <li style="margin-bottom: 10px;">
