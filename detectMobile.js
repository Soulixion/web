document.addEventListener('DOMContentLoaded', function () {
  ...
  function createWarningMessage() {
      ...
      messageDiv.innerHTML = `
          <h2 style="font-size: 40px; color: #ffdd57; margin-bottom: 40px; font-weight: bold;">Avertissement</h2>
          ...
          <div style="margin-top: 40px;">
              ...
              <ul style="list-style: none; padding: 0; margin: 15px 0;">
                  <li style="margin-bottom: 15px;">
                      <a href="https://www.youtube.com/@Soulixion" target="_blank" style="color: #0000ff; text-decoration: underline;">Ma chaîne Youtube</a>
                  </li>
                  <li style="margin-bottom: 15px;">
                      <a href="https://soulixion.itch.io/" target="_blank" style="color: #0000ff; text-decoration: underline;">Mon compte itch.io</a>
                  </li>
                  <li style="margin-bottom: 15px;">
                      <a href="mailto:soulixion@gmail.com" target="_blank" style="color: #0000ff; text-decoration: underline;">Mon adresse e-mail (soulixion@gmail.com)</a>
                  </li>
                  <li style="margin-bottom: 15px;">
                      <a href="https://discord.com/users/soulixion" target="_blank" style="color: #0000ff; text-decoration: underline;">Mon discord (soulixion)</a>
                  </li>
              </ul>
          </div>
          <div style="margin-top: 40px;">
